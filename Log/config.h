...
#ifndef CATLOG_CONFIG_H
#define CATLOG_CONFIG_H
    ...
    public:
        ...
        std::string toString() override {
            try {
                ...
                CatLog_LOG_ERROR(CatLog_LOG_ROOT()) << "ConfigVar::toString exception "
        ...
        bool fromString(const std::string& val) override {
            try {
                ...
                CatLog_LOG_ERROR(CatLog_LOG_ROOT()) << "ConfigVar::fromString exception "
    ...
    public:
        ...
        static typename ConfigVar<T>::ptr Lookup(const std::string& name,
            ...
            if(it != GetDatas().end()) {
                ...
                if(tmp) {
                    CatLog_LOG_INFO(CatLog_LOG_ROOT()) << "Lookup name=" << name << " exists";
                    return tmp;
                } else {
                    CatLog_LOG_ERROR(CatLog_LOG_ROOT()) << "Lookup name=" << name << " exists but type not "
            ...
            if(name.find_first_not_of("abcdefghikjlmnopqrstuvwxyz._012345678")
               != std::string::npos) {
                CatLog_LOG_ERROR(CatLog_LOG_ROOT()) << "Lookup name invalid " << name;
